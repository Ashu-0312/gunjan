...
import kotlinx.android.synthetic.main.activity_joined_communites.progress_bar
import kotlinx.android.synthetic.main.activity_joined_communites.swipe_refresh
...
class JoinedCommunitesActivity : AppCompatActivity() {
    ...
    private fun initializeAdapter() {
        ...
        isLastPage = false
        isLoading = false
        communitiesAdapter = JoinedCommunitiesAdapter(this, communityList)
